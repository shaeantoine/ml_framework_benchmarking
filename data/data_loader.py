...
def resize_image(data, target_size=(224,224)):
    ...
    for idx, img in enumerate(data):
        ...
        img_resized = np.transpose(img_resized, (2, 0, 1))  # (3, 224, 224)
        resized.append(img_resized)

        if idx % 100 == 0:
            print(f"Changing image size, image number {idx}")
